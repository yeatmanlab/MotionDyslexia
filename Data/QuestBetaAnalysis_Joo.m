function [t, sd, betaEstimate, betaSd] = QuestBetaAnalysis_Joo(q,fid)
...
for i=1:length(q(:))
	[t(i), sd(i), betaEstimate(i), betaSd(i)]=QuestBetaAnalysis1(q(i),fid);
end
return

function [t, sd, betaEstimate, betaSd] = QuestBetaAnalysis1(q,fid)
for i=1:16
	q2(i)=q;
	q2(i).beta=2^(i/4);
	q2(i).dim=250;
